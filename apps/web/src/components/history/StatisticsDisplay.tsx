  ...
  return (
    <div className="space-y-1">
      ...
      <div className="pb-2 border-b border-[var(--glass-border)]">
        <StatItem label={t('history.mo3', 'mo3')} value={stats.mo3} />
        <StatItem label={t('history.ao5', 'ao5')} value={stats.ao5} />
        <StatItem label={t('history.ao12', 'ao12')} value={stats.ao12} />
      </div>

      {/* Best averages */}
      <div className="pt-1">
        <StatItem label={t('history.bestSingle', 'best')} value={stats.bestSingle} isBest />
        <StatItem label={t('history.bestAo5', 'best ao5')} value={stats.bestAo5} isBest />
        <StatItem label={t('history.bestAo12', 'best ao12')} value={stats.bestAo12} isBest />
      </div>
    </div>
  )
}
