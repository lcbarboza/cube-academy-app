...
console.log("  F[2][2] (at R[2][0]) -> position at R[2][0] = D[0][2] (same position but D takes over)")
console.log("")
...
console.log("  - The position touching R[0][0] is... well, after rotation it's still the same physical location")
console.log("")
