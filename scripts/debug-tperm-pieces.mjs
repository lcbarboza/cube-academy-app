...
console.log(`  UFR corner: U[2][2]=${solved.U[2][2]}, F[0][2]=${solved.F[0][2]}, R[0][0]=${solved.R[0][0]}`)
console.log(`  UBR corner: U[0][2]=${solved.U[0][2]}, B[0][0]=${solved.B[0][0]}, R[0][2]=${solved.R[0][2]}`)
